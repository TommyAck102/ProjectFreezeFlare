...
const versions = [ 
  {major: 2020, minor: 1},
  {major: 2019, minor: 3}, {major: 2019, minor: 2}, {major: 2019, minor: 1},
  {major: 2018, minor: 4}, {major: 2018, minor: 3}, {major: 2018, minor: 2}, {major: 2018, minor: 1},
  {major: 2017, minor: 4}, {major: 2017, minor: 3}, {major: 2017, minor: 2}, {major: 2017, minor: 1},
  {major: 5, minor: 6}, {major: 5, minor: 5}, {major: 5, minor: 4}, {major: 5, minor: 3}, {major: 5, minor: 2},
];
...
function populateOtherVersionsContainer(){
  ...
  versions.forEach(versionToCheck => {
    if(isVersionDifferent(currentVersion, versionToCheck)){
      versionToCheck.page = getCurrentOpenPage();
      processVersion(versionToCheck);
    }
  });
}
...
function isVersionDifferent(currentVersion, versionToCheck) {
  ...
  let wholeCurrentVersion = currentVersion.split(".")[0] + '' + currentVersion.split(".")[1];
...
function processVersion(versionToCheck){
  ...
  xhttp.onreadystatechange = function() {
    if (this.readyState == 4) {
      ...
      if(this.status != 404){
        ...
        let versionName = versionToCheck.major + "." + versionToCheck.minor;
        let versionElement = document.getElementById(versionName);
        versionElement.href = getTargetUrlFromVersion(versionToCheck.major, versionToCheck.minor, "Manual/index.html");
        //versionElement.className = "highlightedversion";
      }
    }
    else{
      let versionName = versionToCheck.major + "." + versionToCheck.minor;
